...
---------------------
##### **Author**
* **Eric Cross** - <Eric.Cross@coenterprise.com>
...
The tool, B2BiDecoder.jar https://coenterprise1.sharepoint.com/:u:/g/ServicesKnowledgeCenter/EVVVuWLNz-tFvVbGxnxyd-ABLgAcJYn232xbXhwfwv4NMQ?e=uioW9D, is designed to take an IBM Sterling Integrator export file ( .xml or .jar ), and extract resources contained within it.
